...
function addUserMessage(userName, message) {
    ...
    messageDiv.innerHTML = `<strong>${userName}:</strong><p>${message}</p>`;
...
// Example usage:
// You can call sendMessage() when the user clicks the send button or presses Enter in the input field.
// This encapsulates the chat functionality into a single function.
